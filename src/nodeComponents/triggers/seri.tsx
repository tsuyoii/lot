import { Card, Col, Divider, Input, Modal, Row, Select, Space, Typography } from "antd";
...
export const FakeData: React.FC<Params> = (props) => {
    ...
    return (
        ...
        <Row>
            ...
            <br />
            <Card title="Default size card" extra={<ExpandOutlined onClick={onOpenDialog}/>} style={{ width: 300 }}>
            {debouncedEdit}
            </Card>
            <Modal
                title="Title"
